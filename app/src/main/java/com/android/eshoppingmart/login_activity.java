    ...
    public class login_activity extends AppCompatActivity implements
        ...
        public void onStart() {
            ...
            if (mVerificationInProgress && validatePhoneNumber()) {
                ...
                startPhoneNumberVerification(ccp.getSelectedCountryCodeWithPlus().concat(mPhoneNumberField.getText().toString()));
        ...
        private void updateUI(int uiState, FirebaseUser user, PhoneAuthCredential cred) {
            ...
            switch (uiState) {
                ...
                case STATE_SIGNIN_SUCCESS:
                    ...
                    startActivity(new Intent(login_activity.this,activity_navbar.class));
                    finish();
                    break;
        ...
        private boolean validatePhoneNumber() {
            String phoneNumber = ccp.getSelectedCountryCodeWithPlus().concat(mPhoneNumberField.getText().toString());
        ...
        public void onClick(View view) {
            ...
            switch (view.getId()) {
                ...
                case R.id.buttonResend:
                    ...
                    resendVerificationCode(ccp.getSelectedCountryCodeWithPlus().concat(mPhoneNumberField.getText().toString()), mResendToken);
